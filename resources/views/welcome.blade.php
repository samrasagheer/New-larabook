            ...
            <div class="card">
                ...
                <div class="card-body">
                    {{-- <form method="POST" action="{{ route('register') }}"> --}}
                        <form method="POST" action="{{route('signup')}}" enctype="multipart/form-data"enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            <label for="country" class="col-md-4 col-form-label text-md-end">{{ __('Country Name') }}</label>
